 ...
 *
 * Splits the transcript into ~300-word chunks, processes up to 3 chunks in parallel
 * per wave, and aligns corrections back into the words array. Marks corrected words
 * with `bedrockCorrected: true`. Falls back gracefully on error — never throws.
 *
