...
4. If a word sounds phonetically similar to a name in the reference data, correct it
...
10. Return ONLY the corrected text with [Segment N]: labels matching the input format`;
}
