...
const {
  ...
  getEntityKindMap,
  getPartyAbbrMap,
  getCanonicalMap, // eslint-disable-line no-unused-vars -- re-imported for submodule initialisation
  getFusedIndex, // eslint-disable-line no-unused-vars -- re-imported for submodule initialisation
} = require('./dataset-builder');

const {
  STOPWORDS,
  COMMON_BLOCK, // eslint-disable-line no-unused-vars -- accessed by dataset consistency test via indexes.js
  TITLE_PREFIXES, // eslint-disable-line no-unused-vars -- accessed by dataset consistency test via indexes.js
  buildPhoneticIndex,
  buildInitialsIndex, // eslint-disable-line no-unused-vars -- invoked by matchers.js internally
} = require('./indexes');
